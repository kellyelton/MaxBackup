...
Evaluate the work:
- **Small** (1 task): Single focused change, ~1-2 hours of work, touches few files
- **Medium** (2-3 tasks): Multiple related changes, clear phases
- **Large** (4+ tasks): Significant feature, needs breakdown into independent chunks
