...
public class InstallCommand : Command, ICommandHandler
{
    ...
    public async Task<int> InvokeAsync(InvocationContext context) {
        ...
        if (current_install is not null) {
            if (current_install.Version == ThisVersion) {
                context.Console.WriteLine($"Already installed: {current_install.Version} {current_install.ExePath}");
                ...
                context.Console.WriteLine($"Older version installed: {current_install.Version} {current_install.ExePath}");
            }
